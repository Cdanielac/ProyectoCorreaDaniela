...
namespace CapaPresentacion.Administrador
{
    public partial class FReporteUsuarios : Form
    {
        ...
        private void FReporteUsuarios_Load(object sender, EventArgs e)
        {
            ...
            //if (LBResultado.Text != null)
            //{
            //    if (Grafico.Series["Series1"] != null)
            //    {
            //        Grafico.Series["Series1"].Points.Clear();
            //    }

            //    int cantidad = LBResultado.Items.Count;
            //    int[] serie = new int[cantidad];
            //    int j = 0;


            //    foreach (object item in LBResultado.Items)
            //    {
            //        serie[j] = (Convert.ToInt32(item));
            //        j++;
            //    }

            //    foreach (object item in serie)
            //    {
            //        Grafico.Series["Series1"].Points.AddXY(item, item);
            //        j++;
